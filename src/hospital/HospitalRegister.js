...
const HospitalRegister = () => {
    ...
    const validateStep = (step) => {
        ...
        if (step === 6) {
            if (!requiredText(formData.treatment)) return 'Treatment details are required';
    ...
    const buildFinalPayload = async () => {
        ...
        return {
            ...
            establishmentyear: uploadedValues.establishmentyear,
            ...
            treatment: parseArrayValue(uploadedValues.treatment),
                            ...
                            <section className="form-section">
                                ...
                                <div className="form-grid">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" name="establishmentyear" value={formData.establishmentyear} onChange={handleInputChange} placeholder="Enter year" />
                                    </div>
                                    <div className="form-group">
                            ...
                            <section className="form-section">
                                ...
                                <div className="form-grid">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" name="downpaymentrequired" value={formData.downpaymentrequired} onChange={handleInputChange} placeholder="Enter down payment requirement" />
                                    </div>
                                </div>
                            </section>
                        )}
                            ...
                            <section className="form-section">
                                ...
                                <div className="form-grid">
                                    <div className="form-group" style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        <textarea name="treatment" value={formData.treatment} onChange={handleInputChange} rows="3" placeholder="Enter treatment types separated by commas" />
                                    </div>
                                    <div className="form-group">

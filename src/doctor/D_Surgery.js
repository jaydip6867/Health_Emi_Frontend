  ...
  const handleAddInclusive = () => {
    ...
    const getCategoriesByType = (typeId) => {
      ...
      axios({
        ...
        data: { surgerytypeid: typeId, search: '' },
      })
        .then((res) => {
        ...
        .catch(() => {
          ...
          const t = (s_type || []).find((x) => x._id === typeId);
          if (t && Array.isArray(t.categories)) setCategories(t.categories);
          else setCategories([]);
        });
    };
    ...
    const selsurgery = (e) => {
      ...
      if (name === 'surgerytypeid') {
        ...
        setsurgery((prev) => ({ ...prev, categoryname: '' }));
      }
    };
    ...
    function btnedit(id) {
      ...
      getCategoriesByType(surgeryobj.surgerytypeid);
      edithandleShow();
    }
                      ...
                      <Row>
                        ...
                        <Col xs={12} md={6} lg={9} xl={10}>
                          <Row>
                              ...
                              <div className="position-relative">
                                ...
                                >
                                  ...
                                  {categories?.map((c, idx) => (
                                    <option key={idx} value={c.categoryname || c.name || c}>
                                      {c.categoryname || c.name || c}
                                    </option>
                                  ))}
                                </Form.Select>
                              </div>
                            ...
                            <Form.Group className="mb-3 col-12 col-lg-8">

                ...
                <Form as={Row}>
                  ...
                  >
                    <div className="position-relative">
                      ...
                      <Form.Select
                        ...
                        onChange={schange}
                        className={`${
                          profileValidationErrors.specialty ? "is-invalid" : ""
                        }`}
                      >
                  ...
                  <Form.Group controlId="Experience" className="mb-3 col-6">
                    <div className="position-relative">
                      ...
                      <Form.Select
                        className={`frm_input text-dark ${
                          profileValidationErrors.experience ? "is-invalid" : ""
                        }`}
                        name="experience"
                    ...
                    <div className="position-relative">
                      ...
                      <Form.Select
                        className={`frm-select ${
                          profileValidationErrors.country ? "is-invalid" : ""
                        }`}
                        name="country"
                  ...
                  <Form.Group as={Col} controlId="State" className="mb-3 col-6">
                    <div className="position-relative">
                      ...
                      <Form.Select
                        className={`frm-select ${
                          profileValidationErrors.state ? "is-invalid" : ""
                        }`}
                        name="state"
                  ...
                  <Form.Group as={Col} controlId="City" className="mb-3 col-6">
                    <div className="position-relative">
                      ...
                      <Form.Select
                        className={`frm-select ${
                          profileValidationErrors.city ? "is-invalid" : ""
                        }`}
                        name="city"
                        onChange={selfrmdata}
                  ...
                  <Form.Group>
                    ...
                    <div className="position-relative row g-1">
                      ...
                      <div className="col-2">
                        <Button
                          className="d-block w-100 theme_btn"
                          onClick={addHospital}
                        >
                          Add
                        </Button>

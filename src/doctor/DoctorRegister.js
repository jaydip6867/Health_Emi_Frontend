                        ...
                        doc_reg === true ? <Col md={5}>
                            <div className='register_doctor bg-white p-3 py-3 px-4 rounded'>
                                ...
                                <div className='form_bottom_div text-center mt-3'>
                                    <p>Already have an Account? <Link to={'/LoginDoctor'} className='form-link'>Login</Link> </p>
                                </div>
                            </div>
                        </Col> : ''
                    }
                                ...
                                <div className='text-center'>
                                    ...
                                    <Form>
                                        <Form.Group as={Col} controlId="fullname" className='position-relative my-3'>
                                            <Form.Control type="text" placeholder="Ex:- 1234" className='otpfield' pattern='[0-9]{4}' />
                                        </Form.Group>
                                    </Form>
                        ...
                        doc_next1 === true ? <Col md={5}>
                            <div className='register_doctor bg-white p-3 py-3 px-4 rounded'>
                                ...
                                <Form>
                                    ...
                                    <Link type="button" to={'/LoginDoctor'} className='btn btn-primary d-block w-100 theme_btn my-3'>
                                        Next
                                    </Link>
                                </Form>
                            </div>

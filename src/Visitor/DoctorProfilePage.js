...
const DoctorProfilePage = () => {
  ...
  async function saveAppointmentData(id) {
    if (patient) {
      try {
        setloading(true);
        if (
    ...
    <>
        ...
        {doctor_profile && (
          <Container className="py-4">
            <Row>
              <Col lg={8}>
                            ...
                            <div className="text-center p-3 bg-white rounded-3 h-100 shadow-sm">
                              <div>
                                ...
                                >
                                  ...
                                  >
                                    <path
                                      d="M11.4546 2.54492C8.12009 2.54492 5.40918 5.25583 5.40918 8.59038C5.40918 11.8613 7.96736 14.5086 11.3019 14.6231C11.4037 14.6104 11.5055 14.6104 11.5819 14.6231C11.6074 14.6231 11.6201 14.6231 11.6455 14.6231C11.6583 14.6231 11.6583 14.6231 11.671 14.6231C14.9292 14.5086 17.4874 11.8613 17.5001 8.59038C17.5001 5.25583 14.7892 2.54492 11.4546 2.54492Z"
                                      fill="#1C2A3A"
                                    />
                                    <path
                                      d="M17.9201 18.0089C14.3692 15.6416 8.57827 15.6416 5.0019 18.0089C3.38554 19.0907 2.49463 20.5543 2.49463 22.1198C2.49463 23.6852 3.38554 25.1361 4.98917 26.2052C6.77099 27.4016 9.11281 27.9998 11.4546 27.9998C13.7964 27.9998 16.1383 27.4016 17.9201 26.2052C19.5237 25.1234 20.4146 23.6725 20.4146 22.0943C20.4019 20.5289 19.5237 19.0779 17.9201 18.0089Z"
                                      fill="#1C2A3A"
                                    />
                                    <path
                                      d="M25.4416 9.34106C25.6453 11.8101 23.8889 13.9738 21.458 14.2665C21.4453 14.2665 21.4453 14.2665 21.4326 14.2665H21.3944C21.318 14.2665 21.2416 14.2665 21.178 14.292C19.9435 14.3556 18.8107 13.9611 17.958 13.2356C19.2689 12.0647 20.0198 10.3083 19.8671 8.39924C19.778 7.36833 19.4216 6.42651 18.8871 5.62469C19.3707 5.38288 19.9307 5.23015 20.5035 5.17924C22.998 4.96288 25.2253 6.82106 25.4416 9.34106Z"
                                      fill="#1C2A3A"
                                    />
                                  </svg>
                                </div>
                            ...
                            <div className="text-center p-3 bg-white rounded-3 h-100 shadow-sm">
                              <div>
                                ...
                                >
                                  ...
                                  >
                                    <path
                                      d="M14.2418 5.09082H6.09636C5.76545 5.09082 5.44727 5.10355 5.14182 5.14173C1.71818 5.43446 0 7.45809 0 11.1872V16.2781C0 21.369 2.03636 22.3745 6.09636 22.3745H6.60545C6.88545 22.3745 7.25455 22.5654 7.42 22.7817L8.94727 24.8181C9.62182 25.7217 10.7164 25.7217 11.3909 24.8181L12.9182 22.7817C13.1091 22.5272 13.4145 22.3745 13.7327 22.3745H14.2418C17.9709 22.3745 19.9945 20.669 20.2873 17.2326C20.3255 16.9272 20.3382 16.609 20.3382 16.2781V11.1872C20.3382 7.12718 18.3018 5.09082 14.2418 5.09082ZM5.72727 15.2726C5.01455 15.2726 4.45455 14.6999 4.45455 13.9999C4.45455 13.2999 5.02727 12.7272 5.72727 12.7272C6.42727 12.7272 7 13.2999 7 13.9999C7 14.6999 6.42727 15.2726 5.72727 15.2726ZM10.1691 15.2726C9.45636 15.2726 8.89636 14.6999 8.89636 13.9999C8.89636 13.2999 9.46909 12.7272 10.1691 12.7272C10.8691 12.7272 11.4418 13.2999 11.4418 13.9999C11.4418 14.6999 10.8818 15.2726 10.1691 15.2726ZM14.6236 15.2726C13.9109 15.2726 13.3509 14.6999 13.3509 13.9999C13.3509 13.2999 13.9236 12.7272 14.6236 12.7272C15.3236 12.7272 15.8964 13.2999 15.8964 13.9999C15.8964 14.6999 15.3236 15.2726 14.6236 15.2726Z"
                                      fill="#3F5FAB"
                                    />
                                    <path
                                      d="M25.4292 6.09636V11.1873C25.4292 13.7327 24.6401 15.4636 23.0619 16.4182C22.6801 16.6473 22.2346 16.3418 22.2346 15.8964L22.2474 11.1873C22.2474 6.09636 19.3328 3.18182 14.2419 3.18182L6.491 3.19455C6.04555 3.19455 5.74009 2.74909 5.96918 2.36727C6.92373 0.789091 8.65464 0 11.1874 0H19.3328C23.3928 0 25.4292 2.03636 25.4292 6.09636Z"
                                      fill="#3F5FAB"
                                    />
                                  </svg>
                                </div>
                            ...
                            <div className="text-center p-3 bg-white rounded-3 h-100 shadow-sm">
                              <div>
                                ...
                                >
                                  ...
                                  >
                                    <path
                                      d="M8.59091 16.5455C13.3355 16.5455 17.1818 12.8416 17.1818 8.27273C17.1818 3.70383 13.3355 0 8.59091 0C3.84628 0 0 3.70383 0 8.27273C0 12.8416 3.84628 16.5455 8.59091 16.5455Z"
                                      fill="#12A79D"
                                    />
                                    <path
                                      d="M13.4147 17.3212C13.8347 17.1048 14.3183 17.423 14.3183 17.8939V24.0667C14.3183 25.2121 13.5165 25.7721 12.5238 25.3012L9.11286 23.6848C8.82013 23.5576 8.36195 23.5576 8.06922 23.6848L4.65831 25.3012C3.66559 25.7594 2.86377 25.1994 2.86377 24.0539L2.88922 17.8939C2.88922 17.423 3.38559 17.1176 3.79286 17.3212C5.23104 18.0467 6.86013 18.4539 8.59104 18.4539C10.322 18.4539 11.9638 18.0467 13.4147 17.3212Z"
                                      fill="#12A79D"
                                    />
                                  </svg>
                                </div>
                            ...
                            <div className="text-center p-3 bg-white rounded-3 h-100 shadow-sm">
                              <div>
                                ...
                                >
                                  ...
                                  >
                                    <path
                                      d="M10.0713 17.5215C9.73425 17.5327 9.40283 17.614 9.15039 17.7666L6.12109 19.5664C3.9537 20.8466 2.63569 19.8964 3.20605 17.4375L3.92871 14.3193C4.04268 13.711 3.80193 12.887 3.38379 12.4688L0.861328 9.94629C-0.621578 8.46335 -0.140196 6.96817 1.92578 6.61328L5.1582 6.08105C5.70299 5.9922 6.34891 5.51066 6.58984 5.0166L8.37695 1.44141C8.84761 0.512455 9.4572 0.0324938 10.0713 0.000976562V17.5215Z"
                                      fill="#FEB052"
                                    />
                                    <path
                                      d="M10.0713 0.00195312C10.7305 -0.0317732 11.3952 0.452158 11.9004 1.45605L13.6875 5.03027C13.9283 5.52459 14.5751 5.99333 15.1201 6.09473L18.3525 6.62695C20.4182 6.9693 20.8998 8.46541 19.417 9.96094L16.8945 12.4834C16.4764 12.9017 16.2356 13.7257 16.375 14.3213L17.0977 17.4385C17.668 19.8974 16.349 20.8612 14.1816 19.5684L11.1523 17.7686C10.8599 17.5918 10.4618 17.5105 10.0713 17.5234V0.00195312Z"
                                      fill="#FEB052"
                                    />
                                  </svg>
                                </div>
                ...
                >
                  <Card.Body className="p-4">
                    ...
                    <p className="text-muted mb-0">{doctor_profile?.aboutme}</p>
                  </Card.Body>
                </Card>
                    ...
                    <Row className="g-3">
                      {doctor_profile.hospitals.map((v, i) => {
                        return (
                          <Col md={6} key={i}>
                            <Card
                              className="border-1 border-opacity-25 shadow-sm h-100"
                    ...
                    <Row className="g-4">
                      {!doctor_profile?.surgeriesDetails ||
                        ...
                        (showAllSurgeries
                          ...
                          <Col md={6} key={index}>
                            <Card
                              className="border-1 pointer shadow-sm border-opacity-25 h-100"
                              style={{ borderRadius: "12px" }}
                              onClick={() => handleServiceModalShow(surgery)}
                            >
                              <Card.Body className="p-3">
                                <Row>
                                  <Col xs={5}>
                                  ...
                                  <Col xs={7}>
                                    <h6 className="fw-bold mb-1 border-bottom pb-2">
                                      {surgery?.name}
                                    </h6>
                                    <p className="text-muted small m-0">
                    ...
                    {filteredSurgeries.length > 4 && (
                      <div className="text-center mt-3">
                        <Button
                          ...
                          size="sm"
                          onClick={() => setShowAllSurgeries((prev) => !prev)}
                        >
                  ...
                  <Card.Body className="p-4">
                    ...
                    {doctor_profile?.allReviewData?.length > 0 ? (
                      doctor_profile?.allReviewData?.map((v, i) => {
                        return (
                          <div
                            className="card p-3 shadow mb-3 cursor-pointer"
                            key={i}
                            onClick={() => handleReviewModalShow(v)}
                          >
                            <div className="d-flex align-items-center pb-2 border-bottom">
                              <Image
                                src={
                                  v?.createdBy?.profile_pic ||
                                  require("../assets/image/doctor_img.jpg")
                                }
                                roundedCircle
                                width={50}
                                height={50}
              ...
              <Col lg={4}>
                {doctor_profile.is_available === false ? <section class="doctor-status">
                  <div class="status-card">
                    ...
                    <div class="status-content">
                      ...
                      <button class="consultation-btn" disabled>
                  ...
                  <div>
                    <Card
                      className={`border-0 shadow-sm mb-4 ${hospitalError ? "error-outline" : ""
                        }`}
                      style={{ borderRadius: "15px" }}
                    >
                      <Card.Body className="p-4">
                            ...
                            >
                              ...
                              {selectedDate ? (
                                    ...
                                    {slots.map((slot, index) => (
                                      <Col xs={4} key={index}>
                                        <Button
                                          ...
                                          style={{
                                            opacity: canSelectSlot(slot)
                                              ? 1
                                              : 0.5,
                                            cursor: canSelectSlot(slot)
                                              ? "pointer"
                                              : "not-allowed",
                                            fontSize: "12px",
                                            padding: "8px 4px",
                                  ...
                                  {selectedTimeSlot && (
                                    <div className="mt-3 p-2 bg-success bg-opacity-10 rounded text-center">
                                      <small className="text-success fw-bold">
                                        ✓ Selected:{" "}
                                        {format(selectedDate, "dd/MM/yyyy")} at{" "}
                                        {selectedTimeSlot}
                                      </small>
                                    </div>
                                  )}
                                ...
                                <div className="text-muted text-center py-3">
                                  <small>
                                    Select a date above to view available time
                                    slots
                                  </small>
                                </div>
                              )}
      ...
      {patient && doctor_profile && (
        <Modal show={show} size="lg" onHide={handleClose} centered>
          <Modal.Header closeButton>
            <Modal.Title>
              {modelpayment ? "Payment" : "Book Appointment"}
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            {modelpayment ? (
              <Row>
                <Col xs={12}>
                  <Form>
                    <Row className="g-4">
                      <Col xs={12}>
                        <div className="card p-3 w-100 bg-p-card  border-0">
                          <p className="text-muted font-600 opacity-75">
                            payment information
                          </p>
                        ...
                        <div>
                          <h6 className="pt-3 text-muted font-600 opacity-75">
                            Selected payment mode
                          </h6>
                          <div className="d-flex flex-column w-25 py-2 align-items-center card  bg-p-card  border-0">
                            <div className="circle-logo rounded-circle   bg-p-mode d-flex align-items-center justify-content-center">
                              <RiSecurePaymentLine
                                color="text-primary"
                                size={22}
                    ...
                    <Row className="g-4">
                      ...
                      <Col xs={4}>
                        ...
                        <Form.Control
                          ...
                          pattern="[6-9][0-9]{9}"
                          className={
                            appointmentErrors.alt_mobile ? "is-invalid" : ""
                          }
                        />
      ...
      {selectedService && (
        ...
        >
          ...
          <Modal.Body>
            <div
              className="p-2 rounded-3 border rounded surgery_model"
                  ...
                  <div className="d-flex align-items-start gap-4">
                    <div>
                      <img
                        ...
                        alt={`surgery photo of ${selectedService?.name}`}
                      />
                    </div>
                    <div>
                      ...
                      <div className="text-center p-1 h-100">
                        <div>
                          ...
                          >
                            ...
                            >
                              <path
                                d="M8.96001 0C5.62546 0 2.91455 2.71091 2.91455 6.04545C2.91455 9.31636 5.47273 11.9636 8.80728 12.0782C8.9091 12.0655 9.01091 12.0655 9.08728 12.0782C9.11273 12.0782 9.12546 12.0782 9.15091 12.0782C9.16364 12.0782 9.16364 12.0782 9.17637 12.0782C12.4346 11.9636 14.9927 9.31636 15.0055 6.04545C15.0055 2.71091 12.2946 0 8.96001 0Z"
                                fill="#1C2A3A"
                              />
                              <path
                                d="M15.4255 15.4639C11.8745 13.0967 6.08364 13.0967 2.50727 15.4639C3.38554 16.5457 2.49463 17.5543 2.49463 19.1198C2.49463 20.6852 3.38554 22.1361 4.98917 23.2052C6.77099 24.4016 9.11281 25.0008 11.4546 25.0008C13.7964 25.0008 16.1383 24.4016 17.9201 23.2052C19.5237 22.1234 20.4146 20.6725 20.4146 19.0943C20.4019 17.9839 19.5237 16.533 17.9201 15.4639Z"
                                fill="#1C2A3A"
                              />
                              <path
                                d="M22.947 6.79614C23.1507 9.26523 21.3943 11.4289 18.9634 11.7216C18.9507 11.7216 18.9507 11.7216 18.9379 11.7216H18.8997C18.8234 11.7216 18.747 11.7216 18.6834 11.747C17.4488 11.8107 16.3107 11.4161 15.4634 10.6907C16.7743 9.51977 17.5252 7.76341 17.3725 5.85432C17.2834 4.82341 16.927 3.88159 16.3925 3.07977C16.8761 2.83795 17.4361 2.68523 18.0088 2.63432C20.5034 2.41795 22.7307 4.27614 22.947 6.79614Z"
                                fill="#1C2A3A"
                              />
                            </svg>
                          </div>
                          <div className="d-flex flex-column mt-1">
                            <span className="fw-bold">
                              {selectedService?.completed_surgery}
                            </span>
                      ...
                      {selectedService.inclusive
                        ...
                        .map((item, index) => (
                          <li key={index} className="mb-1">
                            ...
                            >
                              <path
                                d="M1.16669 5.00016L5.33335 9.16683L13.6667 0.833496"
                                stroke="#2E7D32"
                                strokeWidth="1.5"
                                strokeLinecap="round"
          ...
          <Form className="row g-3">
            ...
            <Form.Group className="col-12">
              ...
              <Form.Control
                as="textarea"
                name="appointment_reason"
                value={addsurgery?.appointment_reason}
                onChange={surghandlechange}
              />
            </Form.Group>
          </Form>
          ...
          {selectedReview && (
            <div className="text-center">
              <div className="mb-4 d-flex justify-content-center align-items-center gap-3">
                <Image
                  src={
                    selectedReview?.createdBy?.profile_pic ||
                    require("../assets/image/doctor_img.jpg")
                  }
                  roundedCircle
                ...
                <div>
                  <h5 className="fw-bold mb-2">
                    {selectedReview?.appointmentid?.patientname}
                  </h5>
                  <div className="d-flex justify-content-center align-items-center mb-3">
                    {[...Array(5)].map((_, idx) => {
                      ...
                      return (
                        <BsStarFill
                          key={idx}
                          className={
                            (idx < filled ? "text-warning" : "text-secondary") +
                            " me-1"
                          }
                          size={18}
                        />
                    ...
                    <span className="ms-2 fw-bold">
                      {Number.isFinite(Number(selectedReview?.rating))
